...
//      housing stock is the same era + same patterns — pre-1960
//      timber on stumps mixed with post-war brick — so our proof
//      anchor is even more directly relevant than for Brunswick
//   2. High first-home buyer activity at the $800K–$1.1M band
...
//
// Same structure as yarraville/brunswick — only the localised copy
  ...
  return (
    <>
      ...
      <div className="hero-section">
        <div className="hero-badge">🏘 For Footscray Buyers</div>
        <h1 className="hero-h">
        ...
        <div style={{ marginTop: 22, display: 'flex', gap: 20, justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          >
            See a real inner-west analysis →
          </Link>
          <a
            href={SAMPLE_PDF}
      ...
      <div className="upload-area">
        ...
        <div style={{ marginTop: 56, marginBottom: 40 }}>
          <div className="section-label" style={{ textAlign: 'center' }}>
            📊 From a real inner-west inspection we analysed
          </div>
          <div
            style={{
              background: '#fff',
          ...
          >
            <div style={{ fontWeight: 600, fontSize: 16, color: 'var(--navy)', marginBottom: 4 }}>
              Public sample: <span className="redact-soft">███</span> Loch Street, Yarraville VIC 3013 (next suburb over)
            </div>
            <div style={{ fontSize: 13, color: 'var(--muted)', marginBottom: 18 }}>
              c.1940 timber weatherboard on stumps · the exact same housing stock you'll see on Barkly St, Footscray West, and Maidstone
            </div>
        ...
        {/* ── WHY FOOTSCRAY BUYERS NEED THIS ── */}
        <div style={{ marginBottom: 40 }}>
          <div className="section-label" style={{ textAlign: 'center' }}>
            🚂 Why Footscray reports are tougher than most
          </div>
            ...
            {[
              {
                ...
                desc: 'Half of Footscray\'s pre-1960s stock has been re-stumped at least once. Inspectors flag inconsistent stump heights, sagging joists, and rising damp — the kind of defects that need careful reading to know if they\'re serious or cosmetic.',
              },
              {
                num: '02',
                label: 'Train-line vibration band',
                desc: 'Properties within ~200m of the Sunbury / Williamstown / Werribee lines often show diagonal wall cracking, loose plaster, and door-frame drift. Inspectors note it but rarely quote remediation — we estimate what reasonable monitoring + tuck-pointing should cost.',
              },
              {
                num: '03',
        ...
        <div style={{ marginBottom: 40 }}>
          <div className="section-label" style={{ textAlign: 'center' }}>
            ❓ Common questions from Footscray buyers
          </div>
...
const FAQS = [
  ...
  {
    q: 'My property is near the train line — should I be worried about the cracking the inspector flagged?',
    a: "Usually no, but it depends on the pattern. Diagonal cracks above doors and windows that stay open under 5mm are almost always cosmetic — caused by minor cyclical movement from train vibration. Stepped cracks through brick mortar joints, cracks that have moved recently (you can see fresh dust), or cracks wider than 5mm at any point need engineering assessment. Our analysis classifies these for you and recommends the right next step.",
  },
  {
  ...
  },
  {
    ...
    a: "We sum all major and minor defects' repair-cost midpoints (using Australian 2026 tradie rates), adjust for severity, and propose a sensible negotiation figure. The number isn't a guarantee — it's a defensible starting position for your conversation with the vendor's agent. The report shows how we got there.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes. Renovated properties in Footscray often have additions that don't match the original era's construction standards, and we flag where the inspector has noted differential settlement, mismatched roof lines, or compliance gaps between the old + new sections. The negotiation language we generate reflects these specifically — they're some of the strongest pushback points you have.",
  },
  {
    q: "I'm in Footscray West / Maidstone / Seddon / Spotswood — still works?",
    a: "Yes — the tool works for any Australian property. The Footscray-specific framing on this page is for SEO; the underlying analysis is identical for Footscray West, Maidstone, Seddon, Spotswood, Yarraville, Williamstown, or anywhere else. Local tradie matching uses your property's actual address.",
  },
  {
