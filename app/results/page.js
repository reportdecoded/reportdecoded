            ...
            <div className="panel-card">
              ...
              >
                ...
                <div>
                  ...
                  <div className="tabular" style={{ fontSize: 13.5, color: 'var(--text)', fontWeight: 600, lineHeight: 1.35, fontFamily: "var(--font-mono),monospace" }}>
              ...
              <div style={{ fontSize: 11.5, color: 'var(--muted)', lineHeight: 1.5, marginBottom: 14, fontStyle: 'italic' }}>
                ...
                <span style={{ marginLeft: 4 }}>
                  Reference value <span style={{ fontFamily: "var(--font-mono),monospace", color: 'var(--muted)' }}>{fmt$(analysis.negotiation_amount)}</span>.
                </span>
              </div>
