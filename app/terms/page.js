...
export const metadata = {
  title: 'Terms of Service â€” Report Decoded',
  description: 'The terms governing your use of Report Decoded â€” buyer subscriptions, agent subscriptions, refunds, and acceptable use.',
  alternates: {
    ...
    <>
      ...
      <main style={{ maxWidth: 760, margin: '48px auto', padding: '0 24px', color: 'var(--text)', lineHeight: 1.7 }}>
        ...
        <p>
          ...
          general Australian tradie rates as of 2026 â€” not bound to your specific property.
        ...
        <p>
          If our system cannot extract a meaningful analysis from your PDF â€” for example
          because the file is a scanned image rather than text-based, or is not an
          AS4349.1 inspection report at all â€” we will automatically refund your payment.
        </p>
        <p>
        ...
        <ul style={{ paddingLeft: 24 }}>
          ...
          <li>
            ...
            first completed report â€” meaning you are not billed until you have used the
