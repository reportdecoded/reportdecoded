...
export const TRADES = {
  ...
  fencer: {
    ...
    strong_keywords: [
      /\bboundary fence\b/i,
      /\btimber fence\b/i,
      /\bcolorbond fence\b/i,
      /\bsteel fence\b/i,
      /\baluminium fence\b/i,
      /\b(?:pool|swimming pool) fence\b/i,
      /\b(?:paling|picket|panel|chain[- ]?link|wrought iron|brick infill|tubular) fenc(?:e|ing)\b/i,
      /\bfence (?:rot|deterioration|posts?|palings?|panels?|rails?|installation|replacement|repair|leaning|tilted|tilting|collapsed|damaged|cracked|broken|height|gaps?|missing|sagging)\b/i,
      ...
      /\b(?:dividing|side|rear|front|street) fence\b/i,
