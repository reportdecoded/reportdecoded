...
export const TRADES = {
  ...
  licensed_builder: {
    ...
    strong_keywords: [
      ...
      /\b(?:hallway|internal|partition|internal partition) walls? (?:bowing|leaning|out of plumb|out of vertical|movement|subsid|settling)\b/i,
      /\b(?:bowing|leaning|out of plumb|bulging) (?:hallway|internal|partition) walls?\b/i,
      /\bwalls? (?:bowing|leaning|out of plumb|bulging).{0,40}(?:foundation|subfloor|stump|settlement|floor|roof pressure)\b/i,
      /\b(?:pressure from (?:the )?(?:roof|floor|foundation))\b/i,
      /\bstructural (?:movement|settlement|failure|assessment|concern|instability)\b/i,
      /\bout of (?:plumb|vertical|level).{0,30}(?:hallway|internal|partition|whole house|whole-house)\b/i,
      /\b(?:hallway|internal).{0,20}out of plumb\b/i,
    ],
    keywords: [
