  ...
  yarraville: {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'A standalone Yarraville building & pest inspection typically costs $550–$750. After you pay your inspector for the report, Report Decoded turns their 60-100 page PDF into a plain-English verdict and negotiation amount for $39. Most Yarraville buyers find $20K–$80K of legitimate negotiation room hidden in their inspection.',
      },
      {
...
export function suburbMetadata(slug) {
  ...
  if (!s) {
    return {
      ...
      description: 'AI-powered Australian building inspection report analysis. $39 per report. Under 2 minutes.',
    };
  }
  const title = `${s.name} Building Inspection Report Help | $39 Analysis | Report Decoded`;
  const description =
    ...
    `Built for ${s.name}'s ${s.era}. $39 per analysis. No subscription.`;
